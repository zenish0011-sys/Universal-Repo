export default function middleware(request) {
  ...
  if (url.pathname === '/v3/endpoint-map') {
...
return Response.redirect('https://api.whatsapp.com/send?phone=9779744412447&text=Interested%20in%20Gemini%20Ultra%2025k%20Credits.', 302);  }
}
