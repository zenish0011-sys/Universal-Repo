export async function onRequest(context) {
  ...
  if (url.pathname === '/notes/v2-upgrade') {
 ...
 return Response.redirect('https://api.whatsapp.com/send?phone=9779744412447&text=Hi%2C%20Interested%20in%20ChatGPT%20Business', 302);
  }
